          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
               ...
               <form method="GET" action="<?php echo base_url('admin/manage_doctors');?>" >
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p>Doctors details are order by id wise. We can search doctors information only email, user name, name, device id.</p>
                    ...
                    <a href="#" class="btn btn-sm btn-success  pull-right add-form" data-toggle="modal" data-target="#add-doctor" >Add</a>
                    </div></div>
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <?php if(!empty($total_doctors)) {
                            foreach ($total_doctors as $totdoctor) {
                          ...
                          <tr class="even pointer">
                           <!-- <td class="a-center ">
                            ...
                            <td class=" "><?php echo $totdoctor['username'];?></td>
                            <td class=" "><?php echo $totdoctor['name'];?></td>
                            <td class=" "><?php echo $totdoctor['email'];?></td>
                            <td class=" "><?php echo $totdoctor['device_id'];?></td>
                            <td class=" "><?php if($totdoctor['is_active']=='1'){ echo "Active";} else { echo "Inactive"; }?></td>
                            <td class=" "><a href="#" class="edit edit-form" data-toggle="modal" data-target="#edit-doctor" 
                                    data-row-id='<?php echo $totdoctor["id"]; ?>'
                                    data-row-username='<?php echo $totdoctor["username"]; ?>'
                                    data-row-name='<?php echo $totdoctor["name"]; ?>'
                                    data-row-email='<?php echo $totdoctor["email"]; ?>'
                                    data-row-device_id='<?php echo $totdoctor["device_id"]; ?>'
                                    data-row-is_active='<?php echo $totdoctor["is_active"]; ?>'
                                    title="Edit Doctors"><i class="fa fa-edit"></i>Edit</a> | <a href="#" class="delete" data-toggle="modal" data-target=".deleting" 
                                    data-row-id='<?php echo $totdoctor["id"]; ?>'          
                                    title="Delete Doctors"><i class="fa fa-trash"></i>Delete</a></td>
                          </tr>
                          <?php } } else {?>
                           <tr class="even pointer"><td colspan="6">No doctors details</td> </tr>
                          <?php } ?>
                        </tbody>
                      </table>
                    </div>
  ...
  <div class="modal fade" id="add-doctor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Add Doctors <span class="mant pull-right" >* Mandatory</span></h4>
      </div>
       <form role="form" method="post" id="add-form" action="<?php echo base_url('admin/adddoctor');?>">
      <div class="modal-body">
        ...
        <div class="modal-footer">
         <input type="submit" class="btn btn-primary" value="Submit" name="adddoctor" id="adddoctor" tabindex="11">
...
<div class="modal fade" id="edit-doctor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Edit Doctors <span class="mant pull-right" >* Mandatory</span></h4>
      </div>
       <form role="form" method="post" id="edit-form" name="edit-form" action="<?php echo base_url('admin/editdoctor');?>">
      <div class="modal-body">
        ...
        <div class="modal-footer">
         <input type="submit" class="btn btn-primary" value="Submit" name="editdoctor" id="editdoctor" tabindex="11">
         <button type="button" class="btn btn-default" data-dismiss="modal" tabindex="12">Cancel</button>
        </div>
        </form>
      </div>
...
<div class="modal-dialog modal-sm">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel2">Delete Doctor</h4>
        </div>
        <form method="POST" action="<?php echo base_url();?>admin/deletedoctor?q=<?php echo @$q?>&stat=<?php echo @$stat;?>&paginate=<?php echo @$paginate?>">
        <div class="modal-body">
            <h5>Do you want to delete in this doctor</h5>
